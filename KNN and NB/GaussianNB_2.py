...
#  p(height|male)* p(wight|male)  from calculateProbability

p_m_x = calculateProbability(X[0],male[0],male[1]) * calculateProbability(X[1],male[2],male[3]) * prob_of_m
p_w_x = calculateProbability(X[0],female[0],female[1]) * calculateProbability(X[1],female[2],female[3]) * prob_of_w
